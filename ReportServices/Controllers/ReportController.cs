...
namespace ReportServices.Controllers
{
    ...
    public class ReportController : Controller
    {
        ...
        {
            ReportCreator report = new ReportCreator(_configuration);
        ...
        public async Task<string> CreateMillenniumHealthReport([FromBody]string json)
        {
            try
            {
                MillenniumHealthCaseReportData obj =  Newtonsoft.Json.JsonConvert.DeserializeObject<MillenniumHealthCaseReportData>(json.ToString());
                ReportCreator report = new ReportCreator(_configuration);
        ...
        {
            TokenCreator tokenCreator = new TokenCreator(_configuration);
            return await tokenCreator.AuthenticateAsync();
        }
        ...
        public async Task<string> TestService()
        {
            try
            {
                ...
                string filePath = Path.Combine(_configuration["reportIconsFolder"].ToString(), "alternate_drug.png");
