...
namespace ReportGenerator
{
    public class ReportCreator
    {
        ...
        public async Task<string> CreatePCRBillingReport(BillingReportDataObject dataSource)
        {

            string filePath = System.Configuration.ConfigurationManager.AppSettings["ReportTemplateLocation"].ToString() + "\\PCRBillingReport.trdx";
