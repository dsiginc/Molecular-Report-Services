...
namespace ReportGenerator
{
    public class ReportCreator
    {
        ...
        public ReportCreator(IConfiguration configuration)
        {
        ...
        public async Task<string> GenerateReport(string template, CaseQualitativeData dataSource)
        {
            ...
            string filePath = Path.Combine(_configuration["ReportTemplateLocation"].ToString(), Guid.NewGuid().ToString() + "_" + DateTime.Now.ToString("yyyyMMdd_HH_mm_ss") + ".trdx");
            //string filePath = _configuration["ReportTempLocation"].ToString() + "\\" + Guid.NewGuid().ToString() + "_" + DateTime.Now.ToString("yyyyMMdd_HH_mm_ss") + ".trdx";
        ...
        public async Task<string> GenerateRunProtocolsReport(RunProtocolsDataInfo dataSource)
        {
            ...
            string filePath = Path.Combine(_configuration["ReportTemplateLocation"].ToString(), "RunProtocol.trdx");
        ...
        public async Task<string> CreateWorksheetReport(WorksheetReportInfo dataSource)
        {
            ...
            string filePath = Path.Combine(_configuration["ReportTemplateLocation"].ToString(), "WorksheetReport.trdx");
        ...
        public async Task<string> CreateLabOrderRequisitionReport(LabOrderReport dataSource, string templateName)
        {
            ...
            string filePath = Path.Combine(_configuration["ReportTemplateLocation"].ToString(), templateName + ".trdx");
        ...
        {
            string filePath = Path.Combine(_configuration["ReportTemplateLocation"].ToString(), "LabOrdersReport.trdx");
        ...
        public async Task<string> CreateToxLabOrderRequisitionReport(ToxLabOrderReportData dataSource, string templateName= "ToxLabOrderRequisitionReport.trdx")
        {
            ...
            string filePath = Path.Combine(_configuration["ReportTemplateLocation"].ToString() ,templateName);
        ...
        public async Task<string> GenerateExtractionReport(string template, ExtractionData dataSource)
        {
            ...
            string filePath = Path.Combine(_configuration["ReportTempLocation"].ToString() ,Guid.NewGuid().ToString() + "_" + DateTime.Now.ToString("yyyyMMdd_HH_mm_ss") + ".trdx");
        ...
        public async Task<string> CreateToxBillingReport(BillingReportDataObject dataSource)
        {
            ...
            string filePath = Path.Combine(_configuration["ReportTemplateLocation"].ToString() ,"ToxBillingReport.trdx");
        ...
        public async Task<string> CreateMillenniumHealthReport(MillenniumHealthCaseReportData dataSource)
        {
            ...
            string filePath = Path.Combine(_configuration["ReportTemplateLocation"].ToString() , dataSource.TemplateName);
        ...
        {
            string filePath = Path.Combine(_configuration["ReportTemplateLocation"].ToString(),"InvoiceTemplate.trdx");
